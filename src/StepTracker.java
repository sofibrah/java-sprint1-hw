...
class StepTracker {
    ...
    public void printStatistics(Scanner scanner) {
        ...
        System.out.println();
        System.out.println("Ты прошел: " + converter.convertToKm(sumMonth) + " км");
        System.out.println("Ого, ты сжог: "+ converter.convertStepsToKilocalories(sumMonth) +" Килокалорий");
        System.out.println();
